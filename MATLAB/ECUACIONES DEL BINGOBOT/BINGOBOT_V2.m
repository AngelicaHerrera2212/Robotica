...
A23 = [ cos(Q3)     ,   0   ,      sin(Q3)      ,   33*cos(Q3)/2;
        sin(Q3)     ,   0   ,      -cos(Q3)     ,   33*sin(Q3)/2;
        0           ,   1   ,      0            ,              0;
        0           ,   0   ,      0            ,              1];
...
T1 = inv(A01)*T_SYMBOL == A12*A23*A34;
...
%% COMPROBAR CON DIRECTA QUE LOS ANGULOS DAN LA POSICION
