...
float MOVE_0 [] = {20, 0, 24, 1};
float MOVE_1 [] = {13, -26, 3, 2};
float MOVE_2 [] = {15.5, -22.5, 3, 2};
float MOVE_3 [] = {17.5, -21, 3, 2};
float MOVE_4 [] = {20, -19, 3, 2};
float MOVE_5 [] = {21, -18, 3, 2};
float MOVE_6 [] = {-20, 0, 24, 2};
float MOVE_7 [] = {19, -2, 16, 2};
...
//  SERIALRECIV();
 ...
 MOVE(MOVE_1[0], MOVE_1[1], MOVE_1[2]);  
 MOVE(MOVE_2[0], MOVE_2[1], MOVE_2[2]);  
 MOVE(MOVE_3[0], MOVE_3[1], MOVE_3[2]);  
 MOVE(MOVE_4[0], MOVE_4[1], MOVE_4[2]);  
 MOVE(MOVE_5[0], MOVE_5[1], MOVE_5[2]);  
 MOVE(MOVE_1[0], MOVE_1[1], MOVE_1[2]);  
...
void MOVE(float P1, float P2, float P3){
    delay (1000);
